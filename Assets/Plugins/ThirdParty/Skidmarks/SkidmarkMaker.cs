...
public class SkidmarkMaker : MonoBehaviour {

	public static SkidmarkMaker Ins { private set; get; }
	public const int maxMarks = 256;         // Maximum number of marks total handled by one instance of the script.
	...
	Vector3[] vertices = new Vector3[maxMarks * 4];
	Vector3[] normals = new Vector3[maxMarks * 4];
	Vector4[] tangents = new Vector4[maxMarks * 4];
	Color[] colors = new Color[maxMarks * 4];
	Vector2[] uvs = new Vector2[maxMarks * 4];
	int[] triangles = new int[maxMarks * 6];
