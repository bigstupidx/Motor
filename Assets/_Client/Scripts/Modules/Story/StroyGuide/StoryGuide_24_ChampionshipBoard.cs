...
namespace GameClient {
	public class StoryGuide_24_ChampionshipBoard : StoryGuideBase {
		...
		public override void OnEvent(EventEnum eventType, params object[] args) {
			...
			if ((string)args[0] == "ChampionshipBoard") {
		...
		public void StartGuide() {
			Task.Reset();
			Task.Append(() => {
				Client.Guide.Log("指向锦标赛");

				Guide.ActiveBlackBack(true);
				Guide.SetWordPos(null, new Vector3(0.5f, 0.5f, 0), (LString.GAMECLIENT_STORYGUIDE_24_CHAMPIONSHIPBOARD_STARTGUIDE).ToLocalized());
