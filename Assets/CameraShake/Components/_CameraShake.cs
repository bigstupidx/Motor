...
namespace ThinksquirrelSoftware.Utilities
{
	...
	public class CameraShake : MonoBehaviour
	{
		...
		#region Singleton
		/// <summary>
		/// The Camera Shake singleton ins.
		/// </summary>
		...
		public void DoShake(CameraShakeArgs args)
		{
			DoShake(args.NumberOfShakes, args.ShakeAmount, args.RotationAmount, args.Distance, args.Speed, args.Decay, args.GuiShakeModifier, args.MultiplyByTimeScale);
		}
