    ...
    public class PCTKEffectsIntroDialogue
    {
        ...
        static void Update()
        {
            if (EditorPrefs.GetBool("PCTK/Effects/Trails/ShownIntroDialogue") == false)  
            {
                ...
                dialogue.Init(Resources.Load("PCTK/Effects/Trails/banner") as Texture2D, new Generic.VersionInformation("Better Trails", 1, 4, 0), Application.dataPath + "/PigeonCoopToolkit/__Effects (Trails) Examples/Pigeon Coop Toolkit - Effects (Trails).pdf");
