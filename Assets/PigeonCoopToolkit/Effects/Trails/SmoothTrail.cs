    ...
    public class SmoothTrail : TrailRenderer_Base
    {
        ...
        protected override void Update()
        {
            ...
            if (_emit)
            {
                ...
                if (_distanceMoved != 0 && _distanceMoved >= MinControlPointDistance) 
                {
        ...
        */
        ...
        public Vector3 GetPointAlongCurve(Vector3 curveStart, Vector3 curveStartHandle, Vector3 curveEnd, Vector3 curveEndHandle, float t, float crease = 1)
        {
            float oneMinT = 1 - t;
